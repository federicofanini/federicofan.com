import { getJourneyPosts, getPost } from "@/data/blog";
...
export async function generateMetadata({
  ...
  let post = await getPost(params.slug, "journey");
  ...
  return {
    ...
    openGraph: {
      ...
      type: "article",
      publishedTime,
      url: `${DATA.url}/journey/${post.slug}`,
      images: [
        {
          url: ogImage,
        },
...
export default async function JourneyArticle({
  params,
}: {
  params: {
    slug: string;
