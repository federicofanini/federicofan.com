...
import { ContributionGraph, ContributionData } from "./ContributionGraph";
  ...
  return (
    <div className={cn("w-full space-y-4", className)}>
      ...
      <div className="space-y-4">
        {/* Title */}
        <h3 className="text-lg font-bold font-museo flex items-center gap-2">
          {title || config.title}
